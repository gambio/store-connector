...
if (defined('StoreKey_MigrationScript')) {
    if (!defined('GambioStoreCacheFacade_included')) {
         ...
         *
         * Cache implementation for Gambio Store.This class is the facade for the GambioStoreCache class.
         * This class is used for migration scripts that can be run after an installation or uninstallation of a package
